              ...
              <div className="glass-card" style={{ padding: '3rem', marginBottom: '2rem' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1.75rem' }}>
                  <div style={{ display: 'flex', gap: '1.25rem', alignItems: 'flex-start' }}>
                    ...
                    <div>
                      <h4 style={{ fontSize: '1.1rem', marginBottom: '0.25rem', color: '#fff' }}>London (HQ)</h4>
                  ...
                  <div style={{ display: 'flex', gap: '1.25rem', alignItems: 'flex-start' }}>
                    ...
                    <div>
                      <h4 style={{ fontSize: '1.1rem', marginBottom: '0.25rem', color: '#fff' }}>Electronic Mail</h4>
                      <p style={{ color: 'var(--text-secondary)', fontSize: '0.95rem' }}>
                  ...
                  <div style={{ display: 'flex', gap: '1.25rem', alignItems: 'flex-start' }}>
                    ...
                    <div>
                      <h4 style={{ fontSize: '1.1rem', marginBottom: '0.25rem', color: '#fff' }}>Direct Line</h4>
                      <p style={{ color: 'var(--text-secondary)', fontSize: '0.95rem' }}>
                        +44 (0) 20 7946 0912
                      </p>
                    </div>
