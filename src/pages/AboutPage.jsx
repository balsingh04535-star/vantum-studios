      ...
      <div className="section-padding" style={{ backgroundColor: '#eceae4' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ marginBottom: '6rem' }}>
            <h2 style={{ marginBottom: '3rem', color: '#111111', fontSize: '2.4rem' }}>Our Core Directives</h2>
            <div className="grid-2" style={{ gap: '2rem' }}>
              {principles.map((p, idx) => (
                ...
                >
                  <div style={{ fontSize: '1.5rem', color: '#ea580c', fontWeight: 800, marginBottom: '0.75rem' }}>
                    0{idx + 1}.
                  </div>
          ...
          <div style={{ marginBottom: '5rem' }}>
            <h2 style={{ marginBottom: '3rem', color: '#111111', fontSize: '2.4rem' }}>Creative Leadership</h2>
