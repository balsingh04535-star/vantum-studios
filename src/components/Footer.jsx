    ...
    <footer className="footer-wrap">
      <div style={{ maxWidth: '1200px', margin: '0 auto', width: '100%' }}>
        ...
        <div className="grid-3" style={{ borderBottom: '1px solid var(--border-subtle)', paddingBottom: '3rem', marginBottom: '3rem' }}>
          <div>
            <h4 style={{ fontSize: '1.2rem', marginBottom: '1.25rem', color: 'var(--text-primary)' }}>Sitemap</h4>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
              <TransitionLink to="/" className="nav-link" style={{ fontSize: '0.95rem' }}>Home</TransitionLink>
              <TransitionLink to="/work" className="nav-link" style={{ fontSize: '0.95rem' }}>Work Showcase</TransitionLink>
              <TransitionLink to="/services" className="nav-link" style={{ fontSize: '0.95rem' }}>Capabilities & Specs</TransitionLink>
              <TransitionLink to="/about" className="nav-link" style={{ fontSize: '0.95rem' }}>Studio Philosophy</TransitionLink>
              <TransitionLink to="/contact" className="nav-link" style={{ fontSize: '0.95rem' }}>Direct Contact</TransitionLink>
            </div>
          </div>
          ...
          <div>
            <h4 style={{ fontSize: '1.2rem', marginBottom: '1.25rem', color: 'var(--text-primary)' }}>Stay Synchronized</h4>
