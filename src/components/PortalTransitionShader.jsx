...
const fragmentShader = `
  uniform float uTransition; // Controls progress 0 -> 1
  ...
  // CLASSIC 3D PERLIN NOISE FUNCTIONS
  ...
  void main() {
    ...
    // Radial gradient opening from center
...
export default function PortalTransitionShader({
  ...
  // Synchronize transitionProgress to uniform
  useEffect(() => {
    if (uniformsRef.current) {
      uniformsRef.current.uTransition.value = Math.max(0, Math.min(1, transitionProgress));
    }
  }, [transitionProgress]);
